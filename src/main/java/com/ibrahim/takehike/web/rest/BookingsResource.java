...
/**
 * REST controller for managing {@link com.ibrahim.takehike.domain.Bookings}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BookingsResource {
     ...
     */
    @PutMapping("/bookings")
    public ResponseEntity<Bookings> updateBookings(@RequestBody Bookings bookings) throws URISyntaxException {
