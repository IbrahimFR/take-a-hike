package com.ibrahim.takehike.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ibrahim.takehike.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ibrahim.takehike.repository.UserRepository.USERS_BY_EMAIL_CACHE);
